          ...
          <div className="booking-summary">
            ...
            {voucherApplied ? (
              <h2 className="total-summary">
                <p>Tổng giá tiền: {total ? total.toLocaleString() : 0}VNĐ </p>
                <p>-</p>
                <p>{((total / 100) * discount).toLocaleString()}</p>
                <p>{(total - (total / 100) * discount).toLocaleString()}</p>
              </h2>
            ) : (
              <h2 className="total-summary">
                Tổng giá tiền: {total ? total.toLocaleString() : 0}VNĐ
              </h2>
            )}
            <div className="form-group">
