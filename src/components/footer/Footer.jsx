    ...
    <div className="Footer">
      <div className="FLists">
        <ul className="FList">
          ...
          <li className="fListItem">Địa điểm quan tâm</li>
        </ul>
        <ul className="FList">
        ...
        <ul className="FList">
          <li className="fListItem">Những khu nghỉ độc đáo</li>
          <li className="fListItem">Tất cả các điểm đến</li>
          <li className="fListItem">Tất cả các điểm đến có chuyển bay</li>
          <li className="fListItem">Tất cả các địa điểm cho thuê xe</li>
          <li className="fListItem">Khám Phá</li>
          <li className="fListItem">Đánh giá của khách hàng</li>
        </ul>
        <ul className="FList">
        ...
        <ul className="FList">
          ...
          <li className="fListItem">Truyền thống</li>
